...
if __name__ == "__main__":
    ...
    plot_sim(
        local_linear_trend_sim, "Local linear trend model", 1, local_linear_trend_df
    )
    ...
    plot_sim(
        time_domain_seasonal_sim,
        "Time domain seasonal model",
        0,
        time_domain_seasonal_df,
    )
    ...
    frequency_domain_seasonal_sim = DLGM.simulate_model(
        frequency_domain_seasonal_df, a0, P0
    )

    plot_sim(
        frequency_domain_seasonal_sim,
        "Frequency domain seasonal model",
        0,

...
if __name__ == '__main__':
    ...
    local_level_sim = LGM.simulate_model(local_level_df, a0, P0)
    ...
    local_linear_trend_sim = LGM.simulate_model(local_linear_trend_df, a0, P0)
    ...
    time_domain_seasonal_sim = LGM.simulate_model(time_domain_seasonal_df, a0, P0)
    ...
    combined_sim = LGM.simulate_model(combined_df, a0, P0)
    ...
    frequency_domain_seasonal_df = md.get_frequency_domain_seasonal_model_data(100, s, sigma2_omega,
                                                                               H)
    frequency_domain_seasonal_sim = LGM.simulate_model(frequency_domain_seasonal_df, a0, P0)
    ...
    ARMA_sim = LGM.simulate_model(ARMA_df, a0, P0)
    ...
    ARIMA_sim = LGM.simulate_model(ARIMA_df, a0, P0)
    ...
    SARMA_sim = LGM.simulate_model(SARMA_df, a0, P0)
    ...
    ARMA_x_SARMA_df = md.get_ARMA_x_SARMA_model_data(100, phi_terms, theta_terms,
                                                     s, phi_terms, theta_terms, Q_level)
    ARMA_x_SARMA_sim = LGM.simulate_model(ARMA_x_SARMA_df, a0, P0)
    ...
    SARIMA_sim = LGM.simulate_model(SARIMA_df, a0, P0)
    ...
    ARIMA_x_SARIMA_df = md.get_ARIMA_x_SARIMA_model_data(100, phi_terms, d, theta_terms,
                                                         s, phi_terms, D, theta_terms, Q_level)
    ARIMA_x_SARIMA_sim = LGM.simulate_model(ARIMA_x_SARIMA_df, a0, P0)
